# kotlin-quarkus-sandbox project
...
If you gets errors message like this :  Cannot find the `native-image`
```shell script
...
You can then execute your native executable with: `./build/kotlin-quarkus-sandbox-1.0.0-SNAPSHOT-runner`
